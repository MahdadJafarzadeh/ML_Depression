...
class ML_Depression():
    ...
    def FeatureExtraction(self):
        ...
        for i in np.arange(len(X)):
            ...
            feat = [pow_total, Pow_Delta, Pow_Theta, Pow_Alpha, Pow_Beta, Pow_Sigma, 
                    cA_mean[0], cA_std[0], cA_Energy[0], cD_Energy[0],  cD_mean[0],
                    cD_std[0],  Entropy_D[0], Entropy_A[0], Entropy_Welch, Entropy_fft,
                    Pow_Sigma_slow, Pow_Sigma_fast, Kurt, Skewness, Mean, Median,
                    Spectral_mean, hjorth_activity, hjorth_mobility, hjorth_complexity,
                    Std, coeff_var, diff_mean1, diff_mean2, diff_max1, diff_max2,
                    slope_mean, slope_var, Pow_max_Total, Pow_max_Delta, Pow_max_Theta,
                    Pow_max_Alpha, Pow_max_Beta, Pow_max_Sigma, Pow_max_Sigma_slow,
                    Pow_max_Sigma_fast]
        ...
        return X, y, Feat_train_rp, Feat_test_rp, y_train_rp, y_test_rp
    ...
    #%% Kernel SVM
    def KernelSVM_Modelling(self, X, y, kernel,cv = 10):
        tic = time.time()
...
# Extract features
X, y, Feat_train_rp, Feat_test_rp, y_train_rp, y_test_rp = Object.FeatureExtraction()    
